...
{
    public partial class Vehicle_Random_Body : ComponentBase
    {
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        #region Constructors
        #endregion
        ...
        [Inject]
        public BodyStyleDataService_Interface? bodyStyleDataService { get; set; } = null;
        ...
        private async Task OnBodySelected()
        {
            var configurations = AllConfigurations?
               .Where(x => x.BodyStyleID == SelectedBody)
               .ToList();
        ...
        private async Task GetNext()
        {
            ...
            try
            {
                Console.WriteLine($"{MethodBase.GetCurrentMethod()?.Name} - SelectedBody: {SelectedBody}");
                if ((SelectedBody.HasValue == true) && (SelectedBody != Guid.Empty))
                {
