...
{
    public partial class Configuration_View : ComponentBase
    {
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        #region Constructors
        #endregion
        ...
        private async Task GetVehicleAndConfiguration()
        {
            ...
            if (ConfigurationDataService != null)
            {
                ...
                if (Configuration != null)
                {
                    ...
                    ImageData = null;
                    if ((imagesDataDataService != null) && (vehicleImage != null))
                    {
                        var data = await imagesDataDataService.GetImagesDataByID(vehicleImage.ImageID);
                        if (data != null)
                        {
